function [P_t_full,P_t_ml,P_t_full_comp,P_t_ml_comp] = Facet_Echo_Model_independent_interfaces(op_mode,lambda,bandwidth,P_T,h,v,pitch,roll,prf,beam_weighting,G_0,D_0,gamma1,gamma2,N_b,t,PosTairsnow,PosTsnowice,surface_type,sigma_0_snow_surf,sigma_0_snow_vol,kappa_e,tau_snow,c_s,h_s,sigma_0_ice_surf,sigma_0_lead_surf,sigma_0_mp_surf,ice_std_to_snow_std_ratio)
...
PosTice = PosTsnowice;
%Artificially stretching/compressing the heights within the ice layer by a scale factor:
